        ...
        <Container >
            <Row style={{ marginTop:'50px', marginBottom:'30px', display:'flex'}}>
                ...
                <br/>
                   ...
                   THE RELEVANCE HOUSE  <br />

                   Seestrasse |
                CH 8802 - Kilchberg  <br />
welcome@therelevancehouse.com | www.therelevancehouse.com  <br />

<br />Represented by:  <br />

Anna-Lena Stach & German Ramirez  <br />

<br />Contact:  <br />

Telephone: +41 78 942 47 67  <br />
Email: welcome@therelevancehouse.com  <br />

<br />Register entry:  <br />

Entry in the commercial register.  Registering court: Zug   <br />
Registration number: CHE-341.001.501  <br />

<br />Dispute resolution:  <br />

The European Commission provides a platform for online dispute resolution (OS): https://ec.europa.eu/ consumers/odr.  <br />

​
<br />Liability for Content:  <br />

As service providers, we are liable for own contents of these websites. However, service providers are not obligated to permanently monitor submitted or stored information or to search for evidences that indicate illegal activities. Legal obligations to removing information or to blocking the use of information remain unchallenged. In this case, liability is only possible at the time of knowledge about a specific violation of law. Illegal contents will be removed immediately at the time we get knowledge of them.

​ <br />
<br />Liability for Links:  <br />
...
​
<br /> <br />Data Protection <br />

Thank you for your interest in our website. The protection of your personal data is important to us. In this section we explain how we handle your data.
                   </p>
                </Col>
...
Email: welcome@therelevancehouse.com <br/>
​<br/>
The responsible party is the natural or legal person who alone or jointly with others decides on the purposes and means of processing personal data (names, email addresses, etc.). Revocation of your consent to the processing of your data
Many data processing operations are only possible with your express consent. You may revoke your consent at any time with future effect. An informal email making this request is sufficient. The data processed before we receive your request may still be legally processed.
Right to file complaints with regulatory authorities
If there has been a breach of data protection legislation, the person affected may file a complaint with the competent regulatory authorities. The competent regulatory authority for matters related to data protection legislation is the data protection officer of the Swiss state in which our company is headquartered.  
...
• IP address
These data will not be combined with data from other sources. The website operator has a legitimate interest to ensure an optimized service provided free of technical errors. Therefore server log files have to be stored.
Contact form
...
<br/>Outsourced data processing<br/>
...
<br/>Demographic data collection by Google Analytics<br/>
